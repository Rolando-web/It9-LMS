                ...
                <div class="space-y-2">
                  ...
                  <div class="flex items-center space-x-2">
                    <div class="flex items-center space-x-1">
                      ...
                      <span>{{ \Carbon\Carbon::parse($book->publish_date)->format('Y') }}</span>
                    </div>
                  </div>
                  <a href="{{ route('collection') }}"> <button class="w-full bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-lg text-sm font-medium transition-colors mt-4 cursor-pointer"> Borrow Book</button></a>
                </div>
              </div>
            </div>
          @empty

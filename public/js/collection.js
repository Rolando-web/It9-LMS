            ...
            <div class="flex justify-center">
              ${
                  item.is_borrowed
                      ...
                      : item.copies <= 0
                      ? '<button type="button" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors mb-2">Find Similar Book</button>'
